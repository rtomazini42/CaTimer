...
begin
  ...
  Principal := TContagem.Create(Self);
   ...
   begin
       ...
       if (ComboBox2.Selected.Text = 'Meditação') then
       begin
            Principal.Tipo := 2;
       end;
...
//       if (ComboBox3.Selected.Text = 'Padrão') then
//       begin
//            Principal.Som := True;
//       end;
//       if (ComboBox3.Selected.Text = 'Silêncio') then
//       begin
//            Principal.Som := False;
//       end;
  ...
  begin
    // Exibe uma mensagem de erro caso o valor não seja um número válido ou esteja fora do intervalo
    ShowMessage('Por favor, insira um valor numérico entre 1 e 639.');
  end;



  // Exibe o formulário TContagem
